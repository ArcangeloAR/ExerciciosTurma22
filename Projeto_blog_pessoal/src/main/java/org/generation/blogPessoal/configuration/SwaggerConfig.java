...
public class SwaggerConfig {
	...
	private static Contact contact() {
		...
		return new Contact("Arcangelo A. R.","https://github.com/ArcangeloAR", "ang.arcangelo@gmail.com");
	}
	...
	private static List<Response> responseMessageForGET() {
		return new ArrayList<Response>() {
			...
			
			{
				...
				add(new ResponseBuilder().code("201").description("Objecto Criado!").build());
